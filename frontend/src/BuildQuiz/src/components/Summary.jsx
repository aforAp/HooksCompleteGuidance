...
export default function Summary({userAnswers}) {
    ...
    const skippedPercentage = ((skippedAnswers / userAnswers.length) * 100).toFixed(0);
    const correctPercentage = ((correctAnswers / userAnswers.length) * 100).toFixed(0);
    const wrongPercentage = ((wrongAnswers / userAnswers.length) * 100).toFixed(0);
        return (
      <div id="summary">
