...
const [isFetching, setIsFetching] = useState(false);
 ...
 const oldPlaces  = Array.isArray(userPlaces) ? userPlaces : [];;

  const updatedPlaces = [selectedPlace, ...oldPlaces];
  ...
  // setUserPlaces(updatedPlaces);
   ...
   try {
    ...
    //i want to keep the old states that wont||  changes.
   }
  }
